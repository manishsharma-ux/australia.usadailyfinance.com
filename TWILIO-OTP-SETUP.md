...
1. Sign in at <https://console.twilio.com> — the account this is set up for is
...
4. Open `<your /exec URL>?ping=1` in a browser. It must report:
   ...
   ```json
   { "ok": true, "pong": true, "build": "otp-twilio-verify-2026-09-17", "otp": "configured" }
   ```
...
| Wrong guesses before a new code is needed | 6 | `OTP_MAX_CHECKS`, `Code.gs` |
| How long a verification stays good for | 6 hours | `OTP_TOKEN_TTL_SECONDS`, `Code.gs` |
